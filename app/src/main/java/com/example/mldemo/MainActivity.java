...
import com.example.mldemo.Helper.GraphicOverlay;
import com.example.mldemo.Helper.RectOverlay;
...
public class MainActivity extends AppCompatActivity {
    private  Button faceDetectButton ,textDetectButton ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textDetectButton=findViewById(R.id.detect_text_btn) ;
//        text=findViewById(R.id.textView) ;
        ...
        textDetectButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this,TextDetectionActivity.class).
...
//
//    private void processTextDetection(Bitmap bitmap) {
//        FirebaseVisionImage firebaseVisionImage  = FirebaseVisionImage.fromBitmap(bitmap);
//
//    }
