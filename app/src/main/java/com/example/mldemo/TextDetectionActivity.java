...
public class TextDetectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setSubtitle("Click + buton to insert image"); ;
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (which == 0) {
                    ...
                    if (!checkCameraPermission()) {
                        //camera permission not allowed it ,request it
    ...
    private void pickCamera() {
        //intent to take image form camera ,it will also be save to storage to get high quality image
